          ...
          <el-form
            ...
            <div class="emailCode-row">
              ...
              <CustomButton
                ...
                buttonText="发送验证码"
                loadingText="发送中"
                @click="sendEmailCode('resetPwd')"></CustomButton>
            </div>
            <div class="input-field">
          ...
          <el-form
            ...
            <div class="emailCode-row">
              ...
              <CustomButton
                ...
                buttonText="发送验证码"
                loadingText="发送中"
                @click="sendEmailCode('register')"></CustomButton>
            </div>
            <div class="input-field">
            ...
            <CustomButton
              ...
              loadingText="注册中"
              @click="SignUp"
              :isLoading="loadingList.signUploading"></CustomButton>
          </el-form>
        </div>
      </div>
